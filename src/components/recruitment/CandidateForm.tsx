...
export const CandidateForm = ({ onSuccess, onCancel }: CandidateFormProps) => {
  ...
  const onSubmit = async (data: FormValues) => {
    try {
      ...
      Object.entries(data).forEach(([key, value]) => {
        if (value !== undefined && value !== null) {
          if (key === 'experience') {
            ...
            formData.append(key, value ? value.split(',').map(s => s.trim()).join(',') : '');
          } else {
      ...
      await api.post('/api/recruitment/candidates', formData, {
        headers: {
