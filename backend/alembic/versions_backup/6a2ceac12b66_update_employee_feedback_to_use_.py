"""update_employee_feedback_to_use_employees

Revision ID: 6a2ceac12b66
Revises: f0efd79cb4ef
Create Date: 2024-04-29 13:30:00.000000
...
revision: str = '6a2ceac12b66'
down_revision: Union[str, None] = 'f0efd79cb4ef'
...
def downgrade() -> None:
    ...
    # Recreate the original foreign key constraints pointing to users table
